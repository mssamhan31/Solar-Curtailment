...
For each issue, please rate it according to its importance and its effort by 1-5 scale. Importance of scale 5 means it is a major bug related to the script functionality or miscalculation. Effort is mainly rated based on the estimated time to complete the issue. If it takes more than a week, rate the effort as 5. Generally, we prioritize solving issue with high importance and low effort.
